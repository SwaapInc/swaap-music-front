...
const Header = () => {
    ...
    return (
        <div id="kt_header"
             className="kt-header kt-grid__item kt-grid kt-grid--ver  kt-header--fixed " style={{
            zIndex: '1051'
        }}>
                     ...
                     <div className="kt-header__topbar-item kt-header__topbar-item--search">
                         <div className="kt-header__topbar-wrapper"
                             ...
                             <span className="kt-header__topbar-icon"><i
                                 className="flaticon2-add-1"/></span>
                         </div>
                     </div>
                 ) : (
                     <div/>
                        ...
                        <ul className="kt-nav kt-margin-t-10 kt-margin-b-10">
                            <li className="kt-nav__item kt-nav__item--active">
                                <div className="kt-nav__link"
                                     onClick={() => dispatch(changeLocale(1))}>
                            ...
                            <li className="kt-nav__item">
                                <div className="kt-nav__link"
                                     onClick={() => dispatch(changeLocale(2))}>
                                    <span className="kt-nav__link-icon"><img
                    ...
                    {loading ? (
                        ...
                        <div className="kt-header__topbar-item kt-header__topbar-item--user"
                            ...
                            <div className="kt-header__topbar-wrapper"
                                ...
                                <img src='/dist/assets/media/users/jeremy_morvan.jpg'
                                     alt={user.pseudo}/>
                            </div>
                        </div>
                    ) : (
